...
$routes->add('loginGestionList', '\Ppci\Controllers\LoginGestionController::index');
$routes->add('loginGestionChange', '\Ppci\Controllers\LoginGestionController::change');
$routes->post('loginGestionWrite', '\Ppci\Controllers\LoginGestionController::write');
$routes->post('loginGestionDelete', '\Ppci\Controllers\LoginGestionController::delete');
$routes->add('loginChangePassword', '\Ppci\Controllers\LoginGestionController::changePassword');
$routes->post('loginChangePasswordExec', '\Ppci\Controllers\LoginGestionController::changePasswordExec');
